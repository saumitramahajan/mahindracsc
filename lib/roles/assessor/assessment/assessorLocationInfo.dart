                              ...
                              children: [
                                RichText(
                                    text: TextSpan(
                                        ...
                                        children: [
                                      TextSpan(
                                          text: 'Name of the Safety Incharge:'),
                                      TextSpan(
                                          text: ((provider.infoMap[
                                                      'safetyInchargeName'] ==
                                                  '')
                              ...
                              children: [
                                RichText(
                                    text: TextSpan(
                                        ...
                                        children: [
                                      TextSpan(
                                          text: 'Name of the Fire Incharge:'),
                                      TextSpan(
                                          text: ((provider.infoMap[
                                                      'fireInchargeName'] ==
                                                  '')
                                ...
                                RichText(
                                    text: TextSpan(
                                        ...
                                        children: [
                                      TextSpan(
                                          text: 'Email of the Fire Incharge:'),
                                      TextSpan(
                                          text: ((provider.infoMap[
                                                      'fireInchargeEmail'] ==
                                                  '')
                            ...
                            children: [
                              RichText(
                                  text: TextSpan(
                                    ...
                                    TextSpan(
                                        text: (provider.infoMap['testBedValue'])
                                            ? 'Yes'
                                            : 'No',
                                        style: TextStyle(
                                            fontWeight: FontWeight.bold))
